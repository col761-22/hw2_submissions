...
def runvf2():
    ...
    for dir in allgrfs:
        # print('running',dir)
        st=subprocess.run('./a.out '+ './queries/'+allsubgrfs[0]+' '+ './res/'+dir,shell=True, capture_output=True)
        # print(str(st.stdout))
        if 'done' in str(st.stdout):
...
if __name__=='__main__':
    # tracemalloc.start()
    preprocessing.main(sys.argv[1],'op_1')
